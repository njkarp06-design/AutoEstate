...
LISTING_RECORD_REMINDER = (
    ...
    "your reply presents a new listing via listing-to-social or a status "
    "change via listing-status-update):\n\n"
    ...
    "drop), Under Contract, or Sold instead - and Area/Rooms/Size must "
    "still be restated in the footer, not assumed from earlier in the "
    "conversation.\n\n"
