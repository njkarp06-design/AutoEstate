...
**Status (2026-07-26):** everything through PR #34 is merged into `main` — the redesigned UI (#13), turn grouping (#15), the Listings page (#21), and the buyer-inquiry Inquiries dashboard (#34). Still **only ever run locally** (`npm run dev`, port 4127); not deployed to Vercel Pro, which is a tracked next step.
